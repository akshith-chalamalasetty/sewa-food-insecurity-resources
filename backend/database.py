...
# Local dev: SQLite file (no setup needed).
# Production (Render): set DATABASE_URL to the Render Postgres connection string
# so data persists across deploys and restarts.
